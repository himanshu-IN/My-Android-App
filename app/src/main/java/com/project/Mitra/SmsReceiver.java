        ...
        if (intent.getAction().equals("android.provider.Telephony.SMS_RECEIVED")) {
            ...
            if (pdus != null) {
                ...
                for (int i = 0; i < msgs.length; i++) {
                    ...
                    else if(arr[0].equalsIgnoreCase("Mitra") && arr[1].equalsIgnoreCase("forgot") && arr[2].equalsIgnoreCase("login") && arr[3].equalsIgnoreCase("password")) {
                    ...
                    else if(msgLength==2 && arr[0].equalsIgnoreCase("Mitra") && arr[1].equalsIgnoreCase("help")) {
                    ...
                    else if(msgLength>2 && arr[0].equalsIgnoreCase("Mitra") && arr[1].equals(secret_code)) {
